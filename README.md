...
\end{equation}
where $\eta = 10^{-6}$ is the quantum fluctuation scaling factor, and $\delta_{\rm fluct} \sim 10^{-6}-10^{-3}$ for Sgr A* and binary mergers \cite{LIGO_O4}.
...
\end{equation}
yielding the first acoustic peak at $\ell = 220$: $C_\ell = 1.08 \times 10^{-10}$ (error $\sim 1.8\%$ vs Planck 2018 \cite{Planck2018}), resolving CMB structure without inflation.
...
\hline
Earth-Moon & 3.8 cm/yr & 3.78 cm/yr & Apollo LLR \cite{Apollo} & 0.8\% \\
'Oumuamua & 26 km/s & 25.2 km/s & Gaia DR4 \cite{GaiaDR4} & 3.1\% \\
Milky Way & 225 km/s & 223.2 km/s & Gaia DR4 \cite{GaiaDR4} & 0.8\% \\
GW231123 & $\rho = 9.08 \times 10^{-6}$ & $\rho = 8.92 \times 10^{-6}$ & LIGO O4 \cite{LIGO_O4} & 1.8\% \\
Sgr A* & $\theta = 1.50''$ & $\theta = 1.48''$ & EHT 2025 \cite{EHT_2025} & 1.3\% \\
CMB Peak & $C_\ell(l=220) = 1.10 \times 10^{-10}$ & $C_\ell(l=220) = 1.08 \times 10^{-10}$ & Planck 2018 \cite{Planck2018} & 1.8\% \\
Hubble & $H_0 = 67.4$ km/s/Mpc & $H_0 = 67.1$ km/s/Mpc & DESI DR2 \cite{DESI_DR2} & 0.4\% \\
\hline
\end{tabular}
